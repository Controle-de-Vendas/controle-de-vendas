...
/**  
 * 
 * <p>A classe CadastroCliente cria um "JDialog" (janela) que cadastra os produtos.</p>  
	...
	private void botaoSalvar(ActionEvent evt) {
		...
		if(id != null) {
			...
			if(nomeProduto.equals("") || quantidadeProduto.equals("")) {
		    	...
		    	Object[] cadastro = new Object[]{id, nome, df.format(preco), quantidadeVendida, quantidade};

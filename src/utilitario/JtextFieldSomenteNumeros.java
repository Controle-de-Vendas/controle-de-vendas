...
/**  
 * 
 * <p>A classe JtextFieldSomenteNumeros serve para restringir o usuario digitar apenas números em um campo.</p>  
...
public final class JtextFieldSomenteNumeros extends JTextField {
	...
	public  JtextFieldSomenteNumeros(int maximo) {
		...
		/**
		 * Método que restringe o usuario digitar apenas números em um campo.
		 * @param Evento do teclado.
		 */

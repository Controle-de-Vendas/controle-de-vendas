...
public class Telaprincipal extends JFrame {
    ...
    private void botaoPesquisarVendasActionPerformed(ActionEvent evt) {                                                     
    	limpaTabelaVenda();
    ...
    private void botaoPesquisarProdutosActionPerformed(ActionEvent evt) {                                                       
    	limpaTabelaProduto();
    ...
    private void botaoExcluirProdutosActionPerformed(ActionEvent evt) {
    ...
    private void botaoExcluirVendasActionPerformed(ActionEvent evt) {                                                   
    ...
    private void menuItemClienteActionPerformed(ActionEvent evt) {                                                
    	CadastroCliente cadastroCliente = new CadastroCliente(this, true);
    	cadastroCliente.setVisible(true);
    }                                               

    private void menuItemVendedorActionPerformed(ActionEvent evt) {                                                 
    ...
    private void menuItemGerenteActionPerformed(ActionEvent evt) {                                                
    ...
    private void botaoNovoVendasActionPerformed(ActionEvent evt) {                                                
    ...
    private void botaoNovoProdutosActionPerformed(ActionEvent evt) {                                                  
    ...
    private void botaoEditarProdutosActionPerformed(ActionEvent evt) {                                                    
    	int linhaSelecionada = tabelaProdutos.getSelectedRow();  	
    	DefaultTableModel ModelTabelaProduto = (DefaultTableModel) tabelaProdutos.getModel();
    	if(linhaSelecionada == -1) {
    		JOptionPane.showMessageDialog(this,"Selecione uma linha, por favor.");
    ...
    private void botaoEditarVendasActionPerformed(ActionEvent evt) {                                                  
    	int linhaSelecionada = tabelaVendas.getSelectedRow();  	
    	DefaultTableModel ModelTabelaVenda = (DefaultTableModel) tabelaVendas.getModel();
    	if(linhaSelecionada == -1) {
    		JOptionPane.showMessageDialog(this,"Selecione uma linha, por favor.");
    ...
    private void tabelaVendasMouseClicked(MouseEvent evt) {
    	int linhaSelecionada = tabelaVendas.getSelectedRow();  	
    	DefaultTableModel ModelTabelaVenda = (DefaultTableModel) tabelaVendas.getModel();
    	Integer id = Integer.parseInt(ModelTabelaVenda.getValueAt(linhaSelecionada, 0).toString());
    	if (evt.getClickCount() == 2) {
    		VizualizarItens vizualizarItens = new VizualizarItens(this, true);
    ...
    private void iniciarLayout() {
        ...
        botaoEditarVendas.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                botaoEditarVendasActionPerformed(evt);
            }
        });
        ...
        botaoExcluirVendas.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                botaoExcluirVendasActionPerformed(evt);
            }
        });
        ...
        botaoNovoVendas.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                botaoNovoVendasActionPerformed(evt);
            }
        });
        
        botaoPesquisarVendas.setBackground(new Color(242, 242, 242));
        botaoPesquisarVendas.setForeground(new Color(255, 255, 255));
        botaoPesquisarVendas.setIcon(new ImageIcon(getClass().getResource("/imagens/pesquisar.png"))); // NOI18N
        ...
        botaoNovoProdutos.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                botaoNovoProdutosActionPerformed(evt);
            }
        });

        botaoPesquisarProdutos.setBackground(new Color(242, 242, 242));
        botaoPesquisarProdutos.setIcon(new ImageIcon(getClass().getResource("/imagens/pesquisar.png"))); // NOI18N
        ...
        botaoPesquisarProdutos.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                botaoPesquisarProdutosActionPerformed(evt);
            }
        });
